...
from gemini_sdk import GeminiEmbeddings  # Import Gemini API

# Initialize Gemini embeddings
gemini_api_key = "AIzaSyB11aHjABr6ProGjxF_xBs-OgJo45TYg38"  # Replace with your actual Gemini API key
...
file_path = "faiss_store_gemini.pkl"  # Updated file path for storing serialized FAISS index 
...
if process_url_clicked: 
    ...
    # Create embeddings from documents and build FAISS index using Gemini embeddings
    vectorstore_gemini = FAISS.from_documents(docs, gemini_embeddings)
    pkl = vectorstore_gemini.serialize_to_bytes()
...
if query:
    if os.path.exists(file_path):
        with open(file_path, "rb") as f:
            ...
            vectorstore = FAISS.deserialize_from_bytes(embeddings=gemini_embeddings, serialized=pkl, allow_dangerous_deserialization=True)
